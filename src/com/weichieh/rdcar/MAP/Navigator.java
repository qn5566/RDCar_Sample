package com.weichieh.rdcar.MAP;
...
public class Navigator {
	...
	public Navigator(GoogleMap map){
		this.map = map;
	}
	
	public void setStartPosition(LatLng startLocation){
		this.startPosition = startLocation;
	}
	
	public void setEndPosition(LatLng endLocation){
		this.endPosition = endLocation;
	}
